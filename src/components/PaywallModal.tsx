            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              ...
              >
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li className="flex items-center gap-2"><CheckCircle2 size={16} className="text-green-500" /> 48 horas de chat sobre contexto processual (4 chats)</li>
                </ul>
              </div>
              ...
              >
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li className="flex items-center gap-2"><CheckCircle2 size={16} className="text-green-500" /> 48 horas de chat sobre contexto processual (12 chats)</li>
                </ul>
              </div>
            </div>
